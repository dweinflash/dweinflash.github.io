...
This project introduces an On-Call Support Agent built with Slack, Claude Sonnet, RAG and MCP to support engineers with incident response and system design. The agent integrates Retrieval-Augmented Generation (RAG) for searching
