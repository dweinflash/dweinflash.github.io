...
Configure a system that uses a robot’s camera feed and a deep neural network to perform object classification on a Raspberry Pi. Attempt to teach the robot to play a game of "Rock, Paper, Scissors".
